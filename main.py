...
token ='7615132851:AAHh7WUXXMoNPbr-Q8MmJ9BerkNoGZ15iGc'
...
#import requests
    ...
    # Handle the case where req.json() fails
    print(f"Error decoding JSON response: {req.text}") 
    ms = "An error occurred while processing the request." # Or any other appropriate message
    return ms
	except:
...
You are Subscribed dar666787 BOT ♕!
